 ...
 * simply have no compassion for others and kill without qualms if doing so 
 * is convenient. Others actively pursue evil, killing for sport or out of 
 * duty to some evil deity or master.
 * 
 ...
 * being good or evil is an attitude that one recognizes but does not choose. 
 * Being neutral on the good-evil axis usually represents a lack of commitment 
 * one way or the other, but for some it represents a positive commitment to a 
 * balanced view. While acknowledging that good and evil are objective states, 
 * not just opinions, these folk maintain that a balance between the two is 
 * the proper place for people, or at least for them.
 * 
 * Animals and other creatures incapable of moral action are neutral rather 
 * than good or evil. Even deadly vipers and tigers that eat people are neutral
 ...
 * say that only unfettered personal freedom allows people to express 
 ...
 * personality trait that is recognized rather than being chosen. Neutrality 
 * on the lawful-chaotic axis is usually simply a middle state, a state of 
 * not feeling compelled toward one side or the other. Some few such neutrals, 
 * however, espouse neutrality as superior to law or chaos, regarding each as 
 * an extreme with its own blind spots and drawbacks.
 * 
 * Animals and other creatures incapable of moral action are neutral. 
 * Dogs may be obedient and cats free-spirited, but they do not have the 
 * moral capacity to be truly lawful or chaotic.
 *
 * @author Javier A. Ortiz Bultron <javier.ortiz.78@gmail.com>
 */
public interface D20Alignment extends D20Characteristic {
