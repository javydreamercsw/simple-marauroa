        ...
        implements IDataBaseCardStorage<T>
{
  ...
  @Override
  public synchronized ICardType createCardType(String type) throws DBException
  {
    CardType card_type;
    ...
    {
      card_type = (CardType) getCardType(type);
    }
    return card_type;
  }
          ...
          throws DBException
  {
    if (!attributeExists(attr))
    {
      ...
      LOG.log(Level.FINE, "Created attribute: {0}", new Object[]
      {
        attr
      });
    }
  ...
  @Override
  public synchronized ICardHasCardAttribute addAttributeToCard(ICard card,
  ...
  public synchronized ICardType getCardType(String name)
  {
    try
    {
      HashMap parameters = new HashMap();
