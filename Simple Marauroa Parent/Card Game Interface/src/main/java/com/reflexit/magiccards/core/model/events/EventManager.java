...
/**
 * <p> A manager to which listeners can be attached. This handles the management
 * of a list of listeners -- optimizing memory and performance. All the methods
 * on this class are guaranteed to be thread-safe. </p> <p> Clients may extend.
 * </p>
 *
 * @since 3.2
 */
public abstract class EventManager {
     ...
     *
     * @param listener The listener to be removed; must not be
     * <code>null</code>.
     */
