...
public class ObjectFactory {
    ...
    private static final ObjectChangeListenerAdapter LISTENER
            = new ObjectChangeListenerAdapter();

    /**
     * Decide which listener is to be put to the added object. this is ugly. any
     * ideas welcome (durkham).
     *
     * @param object
