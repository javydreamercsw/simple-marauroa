...
public class SimpleRPAction {
    ...
    public static boolean placeat(SimpleRPZone zone, Entity entity) {
        ...
        if (entity instanceof ClientObjectInterface) {
            if (SimpleRPObjectFactory.createDefaultClientObject(entity).isDisconnected()) {
                return true;
            }
        }
         ...
         */
        if (entity instanceof ClientObjectInterface) {
            ClientObjectInterface player = SimpleRPObjectFactory.createDefaultClientObject(entity);
            ...
            if (zoneChanged) {
                ...
                if (oldZone != null) {
                    ...
                    SimpleSingletonRepository.get().get(SimpleRPRuleProcessor.class).addGameEvent(
